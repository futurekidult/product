...
export default {
  ...
  methods: {
    async getAgencyTest() {
      ...
      this.fileForm.test_result_file = this.attachment;
      this.submitState = this.$store.state.sample.agency.agencyTest.is_submit;
      this.testApplyId =
        this.$store.state.sample.agency.agencyTest.test_apply_id;
      this.agencyForm.isAgency =
        this.$store.state.sample.agency.agencyTest.is_agency;
